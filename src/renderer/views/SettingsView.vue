...
import type { AppConfig, CloseBehavior } from '../../shared/types'
    ...
    <div class="settings-layout">
          ...
          ><div class="settings-form-grid">
            <n-form-item :label="$t('settings.theme')"
              ><n-select
                ...
                @update:value="emit('updateConfig', { themeMode: $event })" /></n-form-item
            ><n-form-item :label="$t('settings.language')"
              ><n-select
                ...
                @update:value="emit('updateConfig', { locale: $event })" /></n-form-item
            ><n-form-item :label="$t('settings.companyReadValidityMonths')"
              ><n-input-number
                ...
                @update:value="
                  emit('updateConfig', { companyReadValidityMonths: $event ?? 3 })
                " /></n-form-item
            ><n-form-item class="settings-form-item-wide" :label="$t('settings.closeBehavior')"
              ><n-radio-group
                ...
                ><n-space wrap
                  ...
                  ><n-radio value="quit">{{ $t('settings.quitDirectly') }}</n-radio></n-space
                ></n-radio-group
              ></n-form-item
            ><n-form-item class="settings-form-item-wide" :label="$t('settings.launchAtStartup')"
              ><n-radio-group
                ...
                ><n-space wrap
                  ...
                  ><n-radio :value="false">{{ $t('settings.disable') }}</n-radio></n-space
                ></n-radio-group
              ></n-form-item
            >
          </div></n-form
      ...
      ><n-card bordered class="settings-card settings-update-card" :title="$t('settings.update')"
        ><div class="settings-update-panel">
          ...
          <n-button :loading="checkingForUpdates" @click="checkForUpdates">{{
      ...
      ><n-card
        ...
        ><div class="settings-danger-panel">
          ...
          <n-popconfirm
            ...
            >{{ $t('settings.uninstallWarning') }}</n-popconfirm
          >
        </div></n-card
      >
    </div>
